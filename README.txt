...
InSpec profile overlay to validate the secure configuration of Crunchy
Data PostgreSQL 9 against
[DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) Crunchy Data
PostgreSQL 9.x STIG Version 1 Release 4 tailored for [CMS ARS
...
[issue](https://github.cms.gov/ISPG/cms-ars-3.1-moderate-crunchy-data-postgresql-9-stig-overlay/issues/new).
